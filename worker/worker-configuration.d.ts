/* eslint-disable */
// Generated by Wrangler by running `wrangler types --strict-vars=false` (hash: 967dcfd3dea9e8921cae8d596063e398)
// Runtime types generated with workerd@1.20250525.0 2025-05-15 
declare namespace Cloudflare {
	interface Env {
		INTERESTED_CLIENTS: string[];
		MY_TIMEZONE: string;
		MERAKI_API_KEY: string;
		LAMP_MT40_SERIAL: string;
		MERAKI_SHARED_SECRET: string;
		LAMP: DurableObjectNamespace<import("./src/index").LampDurableObject>;
		ASSETS: Fetcher;
	}
}
